...
static void computerInput(){
        ...
        System.out.println("Computer can block now.");
        canBlock();
        showBoard();
...
static boolean canBlock() {
        ...
        board[5] = computerSymbol;
        return true;
        } else if (board[6] == playerSymbol && board[5] == playerSymbol && board[4] == ' ') {
        board[4] = computerSymbol;
        return true;
        ...
        board[8] = computerSymbol;
        return true;
        } else if (board[9] == playerSymbol && board[8] == playerSymbol && board[7] == ' ') {
        board[7] = computerSymbol;
        return true;
        ...
        board[4] = computerSymbol;
        return true;
        } else if (board[7] == playerSymbol && board[4] == playerSymbol && board[1] == ' ') {
        board[1] = computerSymbol;
        return true;
        ...
        board[3] = computerSymbol;
        return true;
        } else if (board[1] == playerSymbol && board[5] == playerSymbol && board[9] == ' ') {
        board[9] = computerSymbol;
        return true;
        ...
        board[5] = computerSymbol;
        return true;
        } else if (board[7] == playerSymbol && board[5] == playerSymbol && board[3] == ' ') {
        board[3] = computerSymbol;
        return true;
        }else
        return false;
